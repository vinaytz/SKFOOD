  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message: 'You are now part of the SKFood family. Welcome aboard! :)',
    ...
    },
    {
      ...
      type: 'promotion',
      title: 'Special Offer!',
      message: 'In the upcoming month, get a flat 20% off when you order more than 3 thalis!',
  ...
  const handleLogout = () => {
    ...
    setIsMobileMenuOpen(false);
     ...
     const navigationItems = [
      ...(isLoggedIn ? [{ path:'/', label: 'Home' }, { path: '/meal-builder', label: 'Order Meal' }, { path: '/orders', label: 'My Orders' }] : []),
    ];
  return (
            ...
            <div className="hidden md:flex items-center space-x-3">
              ...
              {isLoggedIn ? (
                <div className="flex items-center space-x-3">
                  <Link to="" className="flex items-center space-x-2 px-3 py-1.5 bg-primary-100 rounded-lg pointer-events-none" >
              ...
              {isLoggedIn ? (
                <div className="border-t border-primary-200 pt-4 mt-4">
                  <div className="space-y-2">
                    <Link to="/profile" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center space-x-3 px-4 py-2.5 bg-primary-100 rounded-lg">
